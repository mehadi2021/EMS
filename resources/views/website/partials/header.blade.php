...
<header class="header">
    ...
    <a href="#" class="logo"><span>No</span>Vus</a>
    ...
    <nav class="navbar">
        ...
        @if(Auth::check())
        <a href="{{route('cart')}}" style="text-decoration: none;"><span class="qnts">Booking: {{session('cart') ? count(session('cart')) : '0'}} </span></a>
        {{-- <a href="{{route('booking.list', auth()->user()->id)}}" style="text-decoration: none;"><span class="qnts">Booking List   </span></a> --}}
        @endif
